...
namespace pharmacyEnd {
    ...
    public partial class phDataSet : global::System.Data.DataSet {
        ...
        public partial class empDataTable : global::System.Data.TypedTableBase<empRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public empRow AddempRow(string ID, string name, string salary, string rank, string email) {
        ...
        public partial class empRow : global::System.Data.DataRow {
            ...
            public string rank {
                get {
                    try {
                        return ((string)(this[this.tableemp.rankColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'rank\' in table \'emp\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableemp.rankColumn] = value;
                }
            }
            ...
            public bool IsrankNull() {
                return this.IsNull(this.tableemp.rankColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetrankNull() {
                this[this.tableemp.rankColumn] = global::System.Convert.DBNull;
            }
...
namespace pharmacyEnd.phDataSetTableAdapters {
    ...
    public partial class empTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "Delete from emp where ID=?";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `emp` (`ID`, `name`, `salary`, `rank`, `email`) VALUES (?, ?, ?, ?, ?" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE emp SET name=? , salary=? , rank=? , email=? WHERE emp?";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::pharmacyEnd.Properties.Settings.Default.ph;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, name, salary, rank, email FROM emp";
        ...
        public virtual int Fill(phDataSet.empDataTable dataTable) {
        ...
        public virtual phDataSet.empDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            phDataSet.empDataTable dataTable = new phDataSet.empDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(phDataSet.empDataTable dataTable) {
        ...
        public virtual int Insert(string ID, string name, string salary, string rank, string email) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
